...
const MODE_BADGE = {
  cloud:   { icon: Cloud,        label: '외부 AI API로 생성됨', color: 'text-green-400',  bg: 'bg-green-500/10 border-green-500/30' },
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">사내 보안 인식 훈련용 피싱 시뮬레이션 이메일과 위험 신호 정답지를 생성합니다.</p>
        </div>
