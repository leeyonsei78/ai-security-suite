...
from services.iam_audit_service import analyze_iam, generate_markdown_report, SOURCE_LABELS
from services.iam_audit_guide import SOURCE_TYPES, DISCLAIMER
...
async def analyze(request: AnalyzeRequest):
    ...
    result = await analyze_iam(request.source_type, request.content, request.context)
    entry = {
