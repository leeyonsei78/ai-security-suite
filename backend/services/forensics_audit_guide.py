...
ARTIFACT_TYPES = [
    {
        "id": "event_log",
        "label": "시스템/보안 이벤트 로그",
        "meaning": "OS/보안 소프트웨어가 자동으로 남기는 로그온·프로세스 생성·정책 변경 등의 시스템 이벤트 기록입니다.",
        "why": (
    ...
    },
    {
        ...
        "meaning": "브라우저가 방문한 URL·검색어·다운로드 파일을 시각과 함께 저장해두는 로컬 데이터베이스입니다.",
        "why": (
    ...
    },
    {
        ...
        "meaning": "시스템이 부팅·로그인될 때마다 자동으로 실행되도록 등록된 프로그램/스크립트 목록입니다.",
        "why": (
    ...
    },
    {
        ...
        "label": "파일시스템 타임라인",
        "meaning": "파일별 생성·수정·접근 시각(타임스탬프)을 모아 시간순으로 정렬한 기록입니다.",
        "why": (
    ...
    },
    {
        "id": "process_list",
        "label": "실행 중인 프로세스 목록",
        "meaning": "현재 시스템에서 실제로 실행 중인 프로세스의 이름·PID·실행 경로 스냅샷입니다.",
        "why": (
    ...
    },
    {
        "id": "cloud_audit_log",
        "label": "클라우드 감사 로그",
        "meaning": "누가 언제 어떤 API를 호출해 클라우드 리소스를 만들고 바꾸고 지웠는지 기록한 클라우드 제공자의 감사 추적입니다.",
        "why": (
    ...
    },
    {
        ...
        "label": "방화벽/스위치 로그",
        "meaning": "방화벽/라우터/스위치가 남기는 트래픽 허용·차단 기록과 장비 설정 변경 이력입니다.",
        "why": (
