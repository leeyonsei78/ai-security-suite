...
def _real_analyze(assessment_type: str, content: str, context: str) -> dict:
    import anthropic
...
def analyze(assessment_type: str, content: str, context: str) -> dict:
    if IS_MOCK:
        return _enrich(generate_mock_audit(assessment_type, content, context))
    return _enrich(_real_analyze(assessment_type, content, context))
